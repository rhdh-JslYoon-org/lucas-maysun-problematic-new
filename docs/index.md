...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-new](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-new)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-new-gitops](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-new-gitops)

# **Usage**

To access the lucas-maysun-problematic-new application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of lucas-maysun-problematic-new. You can access this namespace through the web console or via your CLI.
